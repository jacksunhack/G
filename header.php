...
<head>
	...
	<link rel="stylesheet" href="<?php staticFiles('CSS/G.css'); ?>" rel="stylesheet" />
	<link rel="stylesheet" href="<?php staticFiles('CSS/shortcode.G.css'); ?>" rel="stylesheet" />
	<link rel="stylesheet" href="<?php staticFiles('CSS/OwO.min.css'); ?>" rel="stylesheet" />
	<link rel="stylesheet" href="<?php staticFiles('CSS/prism.css'); ?>" rel="stylesheet" />
	<link href="https://cdn.bootcss.com/fancybox/3.5.6/jquery.fancybox.min.css" rel="stylesheet">
	<link href="https://cdn.bootcss.com/toastr.js/latest/css/toastr.min.css" rel="stylesheet">
	<script src="<?php staticFiles('JS/DPlayer.min.js'); ?>"></script>
		...
		<div id="header">
			...
			<div id="header-container">
				...
				<div class="clear">
      			...
      			<?php endif; ?>
						<a href="<?php Helper::options()->siteUrl()?>links.html" <?php if ($this->is('page','links')) : ?> class="nav-focus"<?php endif; ?>>友链</a>
